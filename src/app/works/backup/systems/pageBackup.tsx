  ...
  return (
    <main>
      ...
      <div className="h-fit bg-primary px-0 sm:px-12 md:px-20 xl:px-40">
        <div className="flex-row z-10 mt-0 sm:-mt-0 space-y-32 pt-12 sm:pt-24 pb-24">
          <div className="w-full flex flex-col items-start text-center sm:h-auto sm:text-left">
            <div className='w-full h-full lg:w-1/2 px-6 sm:px-0'>
              ...
              <p className="text-secondary w-full text-base my-4">
                Desde que comecei no Roblox aprendi muita coisa e fiz muitos sistemas, muitos dos quais acabei não utilizando, mas que me serviram de base pra muito conhecimento e aprendizado, veja abaixo alguns sistemas que fiz:
              </p>
            </div>
