...
export default function Builds() {  
  ...
  function changeViewer(id: string) {
    let selected = dreams.find((card) => card.id === id) || builds.find((card) => card.id === id) || texturizing.find((card) => card.id === id);
        ...
        <div className="flex-row z-10 mt-0 sm:-mt-0 space-y-32 pt-12 sm:pt-24 pb-24">
          <div className="w-full flex flex-col items-start text-center sm:h-auto sm:text-left">
            ...
            <div className="w-full h-fit px-[10%] flex flex-wrap justify-start sm:px-[0%]">
              <div ref={cardsRef} className='w-full h-full flex flex-wrap justify-start'>
