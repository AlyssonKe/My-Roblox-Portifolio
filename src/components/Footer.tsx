        ...
        <footer className='w-full bg-secondary-gray bg-footer-shadow -z-50'>
            <div className='w-9/12 h-fit mx-auto pt-6'>
                ...
                <ul className='w-fit h-8 mx-auto flex items-center space-x-4 mb-10 min-[400px]:space-x-2'>
                    ...
                    <li className='group h-12 w-12 p-2 sm:h-10 sm:w-10 hover:duration-200'>
                        <a href='https://www.linkedin.com/in/alysson-kennedy/' target="_blank" className='h-full w-full float-left'>
                            <svg className='fill-secondary duration-200 group-hover:fill-primary-blue group-hover:duration-200' viewBox="3 3 44 44">
